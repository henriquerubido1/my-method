    ...
    <div className='pink'>
      ...
      <table className="table-background">
        <tbody>
          ...
          <tr>
            { twelfthWeek.map(day => <td>{ day }</td>) }
          </tr>
          <tr>
            { thirteenthWeek.map(day => <td>{ day }</td>) }
          </tr>
        </tbody>
      </table>
      <h5>Total: 90 days(12,8 weeks).</h5>
    </div>
  )
}
