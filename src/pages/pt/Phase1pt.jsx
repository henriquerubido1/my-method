...
function Phase1pt() {
	...
	return (
		<div className="text-green">
			...
			<p className="text-center mx-10 opacity-75">dica: <a href="https://www.lingodeer.com/home" className="text-violet hover:underline">Lingodeer</a> tende a ser melhor que o <a href="https://www.duolingo.com/learn" className="text-violet hover:underline">Duolingo</a> para línguas asiáticas</p>
