...
function Phase1() {
	...
	return (
		<div className="text-green">
			...
			<p className="text-center mx-10 opacity-75">tip: <a href="https://www.lingodeer.com/home" className="text-violet hover:underline">Lingodeer</a> tends to be better than <a href="https://www.duolingo.com/learn" className="text-violet hover:underline">Duolingo</a> for asian languages</p>
